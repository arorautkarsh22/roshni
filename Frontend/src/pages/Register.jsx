  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 left-1/4 w-96 h-96 bg-gold-300/10 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-primary-500/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-heading text-3xl font-bold text-white mt-4">Create Account</h1>
          <p className="text-gray-400 mt-2">Join the Roshni Creations family</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="glass-card p-8 space-y-5">
          ...
          <p className="text-center text-gray-400 text-sm">
            ...
            <Link to="/login" className="text-gold-300 hover:underline font-medium">
              Login
            </Link>
          </p>
        </form>
