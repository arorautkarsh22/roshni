  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6">
        <h3 className="font-heading text-xl font-semibold text-white group-hover:text-gold-300 transition-colors">
          {category.name}
        </h3>
        <p className="text-gray-400 text-sm mt-1 line-clamp-2">{category.description || 'Explore collection'}</p>
